        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              ...
              <span class="text-muted">3/4 projects are activated</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              ...
              <h4>Open issues</h4>
              <span class="text-muted">231 issues are open</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img data-src="holder.js/200x200/auto/sky" class="img-responsive" alt="200x200" src="data:image/svg+xml;base64," data-holder-rendered="true">
              <h4>Nearest deadline</h4>
              <span class="text-muted">Neared deadline is tomorrow</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img data-src="holder.js/200x200/auto/vine" class="img-responsive" alt="200x200" src="data:image/svg+xml;base64," data-holder-rendered="true">
              <h4>Commits</h4>
              <span class="text-muted">There are 183 commits today</span>
            </div>
          </div>

          <h2 class="sub-header">
              Projects
              <a class="btn-primary btn pull-right" href="newproject">Create new project</a>
          </h2>
